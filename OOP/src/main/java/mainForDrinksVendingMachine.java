...
// Создать торговый кофейный автомат, напитки в автомате должны содержать следующие данные: наименование, объем,
        ...
        // продажи напитков. Сделать согласно принципам ООП, пройденным на семинаре.
            ...
            apparat.addDrink(new ColdDrinks("Coca Cola", 60, 0.5, 10,
                            "да")).
                    addDrink(new ColdDrinks("Fanta", 60, 0.5, 25,
                            "да")).
                    addDrink(new HotDrinks("Cappuccino", 60, 0.3, 60,
                            "нет", "ванильный")).
                    addDrink(new ColdDrinks("MilkSheik", 60, 0.5, 5,
                            "нет")).
                    addDrink(new HotDrinks("Americano", 60, 0.4, 60,
                            "да", "нет"));
